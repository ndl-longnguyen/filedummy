...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24">
      ...
      {/* NDL Ecosystem Showcase Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-panel rounded-3xl p-8 sm:p-12 border border-blue-500/20 relative overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
            <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-400 hover:text-blue-300 group"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {NDL_ECOSYSTEM_APPS.filter((a) => !a.isCurrent).slice(0, 4).map((app) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-5 rounded-2xl bg-slate-900/70 border border-slate-800/90 hover:border-blue-500/40 hover:bg-slate-900 transition-all flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {app.badge && (
                      <span className={`text-[10px] px-2 py-0.5 rounded font-semibold border ${app.badgeColor}`}>
                        {app.badge}
                      </span>
                    )}
                  </div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-500 group-hover:text-blue-400 transition-colors">
